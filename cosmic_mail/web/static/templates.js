      ...
      <div class="field"><label class="field-label">Signature graphic</label>
        ...
        <div class="flex items-center gap-8" style="padding-top:2px">
          <div id="sig-graphic-preview">${agent?.signature_graphic_url
            ? `<img src="${esc(agent.signature_graphic_url)}" alt="Signature graphic" style="width:48px;height:48px;border-radius:8px;object-fit:contain;background:var(--surface-2)">`
            : (agent?.avatar_url
              ? `<img src="${esc(agent.avatar_url)}" alt="Default (avatar)" style="width:48px;height:48px;border-radius:8px;object-fit:contain;background:var(--surface-2);opacity:0.5">`
